...
<c:set var="ubicacion" value="Eliminar Reserva" />
<%@include file="/includes/cabecera.jsp" %>

        <tr>
                <td colspan="2" id="central">
                        <span id="subtitulo">Eliminacion de la reserva</span>
                        <br />
						<br />
                        <br />
                        <br />
                        <form name="formulario" action="${pageContext.request.contextPath}/reservas/eliminar.action" method="GET">
                         ...
                         <tr class="centradoAli">
                             <td colspan="3" class="centradoAli titularTabla">Va a eliminar la siguiente reserva</td>
                         </tr>
                         <tr class="centradoAli">
                             <td colspan="3" class="centradoAli cabeceraLateralTabla">&nbsp;</td>
                         </tr>
                         <tr class="centradoAli">
                         ...
                         <tr class="centradoAli">
                           ...
                           <td width="2%">&nbsp;</td>                                                                                                      <fmt:formatDate value="${franjaDia.horaInicio}" pattern="HH:mm" var="horaPistaInicio"/>
                         ...
                         <tr class="centradoAli">
                             <td class="derechaAli"><input type="submit" value="Eliminar reserva"></td>
                             <td width="2%">&nbsp;</td>
                             <td class="izquierdaAli">
                             <a href="${pageContext.request.contextPath}/${origen}?idCentro=${centro.idCentro}&idActividad=${actividad.idActividad}" class="linkbutton">Cancelar</a> </td>
                         </tr>
					</tbody>
				</table>
                </form>
