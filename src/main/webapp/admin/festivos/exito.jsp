...
<%@ include file="/admin/includes/cabecera.inc" %>
    ...
    <fieldset class="fieldset">
        <legend>Datos generales del Dia Festivo</legend>
            ...
            <tr>
                <td>
                    <table border="0" width="100%" class="texto">
                       <tr>
                            <td width="100%%" class="texto_negrita centradoAli">Día festivo creado con exito</td>
                       </tr>
                       <tr align="right">
                            <td><a href="${pageContext.request.contextPath}/admin/festivos/mostrar.action">Volver</a></td>
                       </tr>
                    </table>
                </td>
            </tr>
